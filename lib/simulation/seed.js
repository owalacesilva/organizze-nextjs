...
export const SEED_CRYPTO_QUOTES = [
	...
	},
	{
		...
		high24h: 5.44,
		low24h: 5.42,
		volume24h: 402_800_000_000,
		marketCap: 638_000_000_000,
	},
	{
		symbol: "ADA",
		name: "Cardano",
...
/**
 * The anonymous savings-rate cohort.
 *
 * A row is a handle and a percentage and there is nowhere else to put
 * anything: no names, no incomes, no amounts. The privacy guarantee in the
 * leaderboard is a property of this shape, not of remembering to redact.
 */
export const SEED_LEADERBOARD_PEERS = [
	{ handle: "User2841", rate: 52.4 },
	{ handle: "User7193", rate: 47.8 },
	{ handle: "User4056", rate: 41.2 },
	{ handle: "User8492", rate: 36.5 },
	{ handle: "User1607", rate: 31.9 },
	{ handle: "User9328", rate: 27.3 },
	{ handle: "User5174", rate: 22.6 },
	{ handle: "User3865", rate: 18.1 },
	{ handle: "User6720", rate: 11.4 },
];
...
export function buildSeedTransactions(reference = new Date()) {
	...
	for (let month = 0; month < 4; month++) {
		...
		push(
			SEED_CATEGORIES.find((category) => category.id === 7),
			monthOffset + 5,
		);
		...
		push(
			SEED_CATEGORIES.find((category) => category.id === 9),
			monthOffset + 20,
		);
