const en = {
	...
	search: {
		...
		keywords: {
			...
			transactions:
				"transactions, entries, expenses, income, statement, spending",
			...
			quotes:
				"quotes, stocks, market, real estate funds, treasury, currencies, dollar, crypto, bitcoin",
	...
	gamification: {
		title: "Rewards",
		subtitle: "Your streak, badges, XP and what tokens can buy",
		loadError: "Could not load your rewards",

		streak: {
			title: "Logging streak",
			label: "Streak",
			days: "{{count}} day in a row",
			days_plural: "{{count}} days in a row",
			empty: "Log a transaction to start a streak",
			loggedToday: "Logged",
			atRisk: "At risk",
			best: "best {{count}} day",
			best_plural: "best {{count}} days",
			nextMilestone: "{{days}} to go for the {{target}}-day milestone",
			allMilestones: "Every milestone reached",
			riskToastTitle: "Your streak is about to break",
			riskToastBody:
				"Log a transaction before midnight to keep your {{count}}-day streak.",
		},

		tokens: {
			label: "Tokens",
			balanceLabel: "{{count}} token available",
			balanceLabel_plural: "{{count}} tokens available",
		},

		level: {
			title: "Level {{level}}",
			toNext: "{{xp}} XP to the next level",
			xpTotal: "{{xp}} XP total",
		},

		quest: {
			title: "Financial Launchpad",
			subtitle: "Three steps to get your account set up",
			progress: "{{done}}/{{total}} done",
			go: "Go",
			reward:
				"Finish all three for a Founding Member badge and {{tokens}} tokens",

			tasks: {
				income: "Add a wallet or log your income",
				budget: "Create one budget category",
				goal: "Set one savings goal",
			},
		},
		...
		trophyRoom: {
			title: "Trophy Room",
			label: "Badges",
			subtitle: "Everything you have unlocked, and what is still to come",
			count: "{{unlocked}} of {{total}}",
		},

		ledger: {
			title: "Where your XP came from",
			subtitle: "Recalculated from your account, never banked",
			empty: "Nothing earned yet",
			source: "Source",
			count: "Times",
			xp: "XP",
			tokens: "Tokens",
			spent: "{{tokens}} tokens spent in the marketplace",

			sources: {
				dailyLog: "Days with a logged transaction",
				budgetCreated: "Budgets created",
				goalCreated: "Goals created",
				goalCompleted: "Goals completed",
				streakMilestone: "Streak milestones",
				badges: "Badges unlocked",
				quest: "Financial Launchpad",
			},
		},

		market: {
			title: "Marketplace",
			subtitle: "Spend tokens on accent themes",
			free: "Included",
			price: "{{tokens}} tokens",
			buy: "Buy",
			locked: "Not enough tokens",
			apply: "Apply",
			active: "Active",
			purchased: "{{name}} unlocked",
		...
		leaderboard: {
			...
			subtitle: "How your savings rate compares, anonymously",
			participate: "Take part",
			privacyNote:
				"Only a percentage and a random handle are ever shared. Never your name, your income or any amount.",
			optedOutHint: "You are not on the board. Turn this on to be ranked.",
			optedIn: "You are on the leaderboard",
			optedOut: "You have been removed from the leaderboard",
			optError: "Could not update your leaderboard setting",
			rank: "#",
			member: "Member",
		...
		badges: {
			firstStep: {
				name: "First Step",
				description: "You logged your very first transaction.",
				howTo: "Log your first transaction.",
			},
			weekStreak: {
				name: "Week One",
				description: "Seven days in a row of logging.",
				howTo: "Log a transaction every day for 7 days.",
			},
			monthStreak: {
				name: "Month Strong",
				description: "Thirty days in a row of logging.",
				howTo: "Log a transaction every day for 30 days.",
			},
			quarterStreak: {
				name: "Quarter Master",
				description: "Ninety days in a row of logging.",
				howTo: "Log a transaction every day for 90 days.",
			},
			firstBudget: {
				name: "Planner",
				description: "You set your first budget.",
				howTo: "Create one budget.",
			},
			budgetKeeper: {
				name: "Budget Keeper",
				description: "Every budget stayed within its limit.",
				howTo: "Keep every budget at or under its limit.",
			},
			firstGoal: {
				name: "Dreamer",
				description: "You set your first savings goal.",
				howTo: "Create one savings goal.",
			},
			goalAchiever: {
				name: "Goal Getter",
				description: "You reached a savings goal.",
				howTo: "Reach 100% on any savings goal.",
			},
			goalCollector: {
				name: "Collector",
				description: "Three savings goals reached.",
				howTo: "Reach 100% on three savings goals.",
			},
			saver: {
				name: "Saver",
				description: "You kept 20% of this month's income.",
				howTo: "Finish a month having saved 20% of your income.",
			},
			superSaver: {
				name: "Super Saver",
				description: "You kept 40% of this month's income.",
				howTo: "Finish a month having saved 40% of your income.",
			},
			foundingMember: {
				name: "Founding Member",
				description: "You completed the Financial Launchpad.",
				howTo: "Finish all three Financial Launchpad steps.",
			},
		},
	},
	...
	import: {
		...
		columnsHint:
			"We guessed from the header — adjust anything that looks wrong.",
	...
	quotes: {
		title: "Quotes",
		subtitle:
			"Market prices across stocks, funds, bonds, currencies and crypto",
		menu: "Asset class",
	...
	settings: {
		...
		security: {
			...
			addIdDescription:
				"Upload an identification document to verify your identity.",
	...
	insights: {
		...
		emptyHint:
			"Add a few transactions — or import a statement — and come back.",
		...
		items: {
			...
			possibleDuplicate: {
				...
				body_plural:
					"{{count}} charges show up twice within a few days, starting with {{description}} of {{amount}}.",
			},
			uncategorized: {
				title: "Rows without a category",
				body: "{{count}} row this month has no category, worth {{amount}}.",
				body_plural:
					"{{count}} rows this month have no category, worth {{amount}} together.",
			},
			weekdayPattern: {
			...
			smallCharges: {
				...
				body_plural:
					"{{count}} small charges add up to {{amount}}, {{percent}}% of the month.",
			},
			walletConcentration: {
