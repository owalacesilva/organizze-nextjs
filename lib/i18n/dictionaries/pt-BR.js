...
>>>>>>> 3db3392 (Issue/5 (#9))
	...
	search: {
		...
		keywords: {
			...
			transactions: "movimentações, lançamentos, despesas, receitas, extrato, gastos",
			...
			quotes: "cotações, ações, bolsa, fundos imobiliários, tesouro direto, moedas, dólar, criptomoedas, bitcoin",
...
=======
	gamification: {
		...
		streak: {
			...
			riskToastBody: "Registre uma movimentação antes da meia-noite para manter seus {{count}} dias.",
		},
		...
		quest: {
			...
			go: "Ir",
			reward: "Conclua os três e ganhe a conquista Membro Fundador e {{tokens}} tokens",
