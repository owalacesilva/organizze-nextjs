const ptBR = {
	...
	search: {
		...
		beta: "Em teste",
		group: "Páginas",
		emptyTitle: "Encontre funcionalidades do sistema",
		emptyDescription: "Use a busca para ir direto ao que você precisa",
		trySearching: "Tente pesquisar palavras como:",
		noResults: "Nada encontrado",
		noResultsHint: 'Nenhuma funcionalidade corresponde a "{{term}}"',

		// Sinônimos separados por vírgula, para a busca chegar à página certa
		// mesmo quando a palavra digitada não aparece no título dela.
		keywords: {
			dashboard: "painel, início, visão geral, resumo, saldo",
			transactions:
				"movimentações, lançamentos, despesas, receitas, extrato, gastos",
			wallets: "carteiras, contas, cartões, banco, saldo",
			budgets: "orçamentos, limites, planejamento, teto de gastos",
			goals: "metas, objetivos, poupança, reserva, economia",
			quotes:
				"cotações, ações, bolsa, fundos imobiliários, tesouro direto, moedas, dólar, criptomoedas, bitcoin",
			analytics: "análises, gráficos, relatórios, tendências, evolução",
			insights: "insights, recomendações, dicas, alertas",
			import: "importar, csv, extrato, planilha, upload",
			categories: "categorias, grupos, classificação, etiquetas",
			profile: "perfil, conta, dados pessoais, nome, foto",
			settings: "configurações, preferências, segurança, tags, idioma, api",
		},
	},

	gamification: {
		title: "Recompensas",
		subtitle: "Sua sequência, conquistas, XP e o que os tokens compram",
		loadError: "Não foi possível carregar suas recompensas",

		streak: {
			title: "Sequência de registros",
			label: "Sequência",
			days: "{{count}} dia seguido",
			days_plural: "{{count}} dias seguidos",
			empty: "Registre uma movimentação para começar",
			loggedToday: "Registrado",
			atRisk: "Em risco",
			best: "recorde de {{count}} dia",
			best_plural: "recorde de {{count}} dias",
			nextMilestone: "Faltam {{days}} para o marco de {{target}} dias",
			allMilestones: "Todos os marcos alcançados",
			riskToastTitle: "Sua sequência está prestes a quebrar",
			riskToastBody:
				"Registre uma movimentação antes da meia-noite para manter seus {{count}} dias.",
		},

		tokens: {
			label: "Tokens",
			balanceLabel: "{{count}} token disponível",
			balanceLabel_plural: "{{count}} tokens disponíveis",
		},
		...
		quest: {
			title: "Decolagem Financeira",
			subtitle: "Três passos para deixar sua conta pronta",
			progress: "{{done}}/{{total}} concluídos",
			go: "Ir",
			reward:
				"Conclua os três e ganhe a conquista Membro Fundador e {{tokens}} tokens",

			tasks: {
				income: "Adicione uma carteira ou registre sua renda",
				budget: "Crie um orçamento por categoria",
				goal: "Defina uma meta de economia",
			},
		},
		...
		trophyRoom: {
			...
			label: "Conquistas",
			subtitle: "Tudo o que você desbloqueou, e o que ainda vem",
			count: "{{unlocked}} de {{total}}",
		},

		ledger: {
			title: "De onde veio seu XP",
			subtitle: "Recalculado a partir da sua conta, nunca acumulado",
			empty: "Nada conquistado ainda",
			source: "Origem",
			count: "Vezes",
			xp: "XP",
			tokens: "Tokens",
			spent: "{{tokens}} tokens gastos na loja",

			sources: {
				dailyLog: "Dias com movimentação registrada",
				budgetCreated: "Orçamentos criados",
				goalCreated: "Metas criadas",
				goalCompleted: "Metas concluídas",
				streakMilestone: "Marcos de sequência",
				badges: "Conquistas desbloqueadas",
				quest: "Decolagem Financeira",
			},
		},

		market: {
			title: "Loja",
			subtitle: "Troque tokens por temas de destaque",
			free: "Incluído",
			price: "{{tokens}} tokens",
			buy: "Comprar",
			locked: "Tokens insuficientes",
			apply: "Aplicar",
			active: "Ativo",
			purchased: "{{name}} desbloqueado",
			purchaseError: "Não foi possível concluir a compra",
			applyError: "Não foi possível aplicar o tema",

			items: {
				default: "Índigo (padrão)",
				emerald: "Esmeralda",
				amber: "Âmbar",
				violet: "Violeta",
				rose: "Rosa",
		...
		leaderboard: {
			...
			subtitle: "Como sua taxa de economia se compara, de forma anônima",
			participate: "Participar",
			privacyNote:
				"Só a porcentagem e um apelido aleatório são compartilhados. Nunca seu nome, sua renda ou qualquer valor.",
			optedOutHint: "Você não está no ranking. Ative para ser classificado.",
			optedIn: "Você entrou no ranking",
			optedOut: "Você saiu do ranking",
			optError: "Não foi possível atualizar sua preferência de ranking",
			rank: "#",
			member: "Participante",
			savingsRate: "Taxa de economia",
			you: "Você",
			yourRank: "Você está em {{rank}}º de {{total}}",
		},
		...
		badges: {
			firstStep: {
				...
				howTo: "Registre sua primeira movimentação.",
			},
			weekStreak: {
				name: "Primeira Semana",
				description: "Sete dias seguidos de registro.",
				howTo: "Registre uma movimentação todos os dias por 7 dias.",
			},
			monthStreak: {
				name: "Mês Firme",
				description: "Trinta dias seguidos de registro.",
				howTo: "Registre uma movimentação todos os dias por 30 dias.",
			},
			quarterStreak: {
				name: "Mestre do Trimestre",
				description: "Noventa dias seguidos de registro.",
				howTo: "Registre uma movimentação todos os dias por 90 dias.",
			},
			firstBudget: {
				name: "Planejador",
				description: "Você criou seu primeiro orçamento.",
				howTo: "Crie um orçamento.",
			},
			budgetKeeper: {
				name: "Guardião do Orçamento",
				description: "Todos os orçamentos ficaram dentro do limite.",
				howTo: "Mantenha todos os orçamentos dentro do limite.",
			},
			firstGoal: {
				name: "Sonhador",
				description: "Você criou sua primeira meta de economia.",
				howTo: "Crie uma meta de economia.",
			},
			goalAchiever: {
				name: "Meta Batida",
				description: "Você alcançou uma meta de economia.",
				howTo: "Chegue a 100% em qualquer meta.",
			},
			goalCollector: {
				name: "Colecionador",
				description: "Três metas de economia alcançadas.",
				howTo: "Chegue a 100% em três metas.",
			},
			saver: {
				name: "Poupador",
				description: "Você guardou 20% da renda deste mês.",
				howTo: "Termine um mês tendo guardado 20% da sua renda.",
			},
			superSaver: {
				name: "Super Poupador",
				description: "Você guardou 40% da renda deste mês.",
				howTo: "Termine um mês tendo guardado 40% da sua renda.",
			},
			foundingMember: {
				name: "Membro Fundador",
				description: "Você concluiu a Decolagem Financeira.",
				howTo: "Conclua os três passos da Decolagem Financeira.",
			},
		},
	},
	...
	import: {
		...
		historyTitle: "Envios",
		historyHint:
			"Todos os extratos que você trouxe, do mais recente para o mais antigo",
		...
		dropHint:
			"ou clique para escolher um arquivo — apenas .csv, até {{size}} MB",
		...
		columnsHint: "Adivinhamos pelo cabeçalho — ajuste o que estiver diferente.",
	...
	quotes: {
		title: "Cotações",
		subtitle: "Preços de ações, fundos imobiliários, títulos, moedas e cripto",
		menu: "Classe de ativo",
		searchPlaceholder: "Buscar cotações...",
		updatedAt: "Atualizado às {{time}}",
		loadError: "Não foi possível carregar as cotações",
		empty: "Nenhuma cotação disponível",
		noMatches: "Nenhuma cotação corresponde à busca",
		noMatchesHint: 'Nada encontrado para "{{term}}"',
		...
		view: {
			...
			showCards: "Ver como cartões",
		},

		details: {
			matured: "Vencido",
			yearsToMaturity: "Falta {{count}} ano",
			yearsToMaturity_plural: "Faltam {{count}} anos",
		},
		...
		columns: {
			...
			indexer: "Indexador",
			maturity: "Vencimento",
			rate: "Rentabilidade anual",
			unitPrice: "Preço unitário",
			minimumInvestment: "Investimento mínimo",
			price: "Preço",
			change: "Variação",
			change24h: "24h",
			dayRange: "Mínima e máxima",
			range24h: "Mínima e máxima 24h",
			volume: "Volume",
			volume24h: "Volume 24h",
			marketCap: "Valor de mercado",
			dividendYield: "Dividend yield",
			lastDividend: "Último rendimento",
			priceToBook: "P/VP",
			bid: "Compra",
			ask: "Venda",
			previousClose: "Fech. anterior",
			changeValue: "Variação (valor)",
			spread: "Spread",
			annualisedDividend: "Rendimento anualizado",
			timeToMaturity: "Prazo até o vencimento",
		},

		sectors: {
			beverages: "Bebidas",
			carRental: "Locação de veículos",
			financial: "Financeiro",
			health: "Saúde",
			industrials: "Bens industriais",
			mining: "Mineração",
			oilGas: "Petróleo e gás",
			pulpPaper: "Papel e celulose",
			retail: "Varejo",
		...
		// A rentabilidade anual é um spread sobre um índice, ou uma taxa fixa.
		rateFormat: {
			ipca: "IPCA + {{rate}}%",
			prefixado: "{{rate}}%",
			selic: "SELIC + {{rate}}%",
	...
	settings: {
		...
		account: {
			...
			emailChangeHint: "Alterar o e-mail exige a verificação do novo endereço.",
			accountType: "Tipo de conta",
			countryChangeHint:
			...
			twoFactorDescription:
				"Adicione uma camada extra de segurança exigindo um segundo passo no signIn.",
	...
	insights: {
		...
		items: {
			...
			possibleDuplicate: {
				...
				body_plural:
					"{{count}} cobranças aparecem duas vezes em poucos dias, começando por {{description}} de {{amount}}.",
			},
			uncategorized: {
				title: "Lançamentos sem categoria",
				body: "{{count}} lançamento deste mês está sem categoria, somando {{amount}}.",
				body_plural:
					"{{count}} lançamentos deste mês estão sem categoria, somando {{amount}}.",
			},
			weekdayPattern: {
			...
			smallCharges: {
				...
				body_plural:
					"{{count}} cobranças pequenas somam {{amount}}, {{percent}}% do mês.",
			},
			walletConcentration: {
